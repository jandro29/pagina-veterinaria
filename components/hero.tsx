export default function Hero() {
  return (
    <section
      id="home"
      className="relative bg-gradient-to-br from-primary/10 to-accent/10 py-20 sm:py-32"
    >
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground">
              En PetCare Vet nos dedicamos a proporcionar el mejor cuidado
              médico y atención personalizada para tus mascotas. Con
              profesionales experimentados y equipamiento moderno.
            </p>
